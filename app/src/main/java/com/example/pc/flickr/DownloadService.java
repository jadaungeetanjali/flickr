        ...
        for (int i= 0; i < urls.length ; i++){
            try {
                if (type[i].equals("movies")){
                    listDataModel = jsonMovieParser(jsonArray.get(0),type[i],subType[i],listDataModel);
                }
                else if (type[i].equals("tv")){
                    listDataModel = jsonTvParser(jsonArray.get(0),type[i],subType[i],listDataModel);
                }
                else{
                    listDataModel = jsonCelebsParser(jsonArray.get(0),type[i],subType[i],listDataModel);
                }
