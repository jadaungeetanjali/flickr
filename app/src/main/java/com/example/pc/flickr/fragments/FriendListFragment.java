...
public class FriendListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.friends_list_toolbar);
        toolbar.setTitle(type);
        FirebaseCurd firebaseCurd = new FirebaseCurd(getActivity());
        switch (type){
            case "WatchList":
                databaseReference = firebaseCurd.getmDataReference().child(id).child("WatchList");
                break;
            case "WishList":
                databaseReference = firebaseCurd.getmDataReference().child(id).child("WishList");
                break;
            case "Favorite":
                databaseReference = firebaseCurd.getmDataReference().child(id).child("Favorite");
                break;
        }
